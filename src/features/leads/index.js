...
const TopSideButtons = () => {
  ...
  const openAddNewLeadModal = () => {
    dispatch(openModal({ title: "Agregar nuevo producto", bodyType: MODAL_BODY_TYPES.LEAD_ADD_NEW }))
  }

  return (
    <div className="inline-block float-right">
      <button className="btn px-6 btn-sm normal-case btn-primary" onClick={() => openAddNewLeadModal()}>Agregar nuevo</button>
    </div>
  )
}
...
function Leads() {
  ...
  return (
    <>
      ...
      <TitleCard title="Lista de Productos" topMargin="mt-2" TopSideButtons={<TopSideButtons />}>
